...
- [Milestone](https://github.com/unity-game-framework/ugf-application/milestone/39?closed=1)  
    

### Fixed

- Fix application ordered try get module returns null ([#105](https://github.com/unity-game-framework/ugf-application/issues/105))  
    - Update dependencies: `com.ugf.runtimetools` to `2.19.0` and `com.ugf.editortools` to `2.18.0` versions.
    - Update package _Unity_ version to `2023.2`.
    - Update package registry to _UPM Hub_.
    - Fix `ApplicationOrdered.OnTryGetModule()` method to properly return result.
