...
{
    public abstract class ApplicationModule<TDescription> : InitializeBase, IApplicationModule<TDescription> where TDescription : class, IApplicationModuleDescription
    {
